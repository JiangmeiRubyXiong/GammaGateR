---
title: "Vignette - using GammaGateR with Vectra Polaris Data"
...
The `VectraPolarisData` package on Bioconductor contains multiplex immunohistochemistry (mIHC) in a sample of 153 patients with small cell lung cancer[@johnson2021cancer;@VectraPolarisData]. To download the dataset, follow the instruction at https://bioconductor.org/packages/release/data/experiment/html/VectraPolarisData.html. After installation, run the following to store data as the `cell` object. The data is are cell-level, meaning that each row of the data represents a single cell.
